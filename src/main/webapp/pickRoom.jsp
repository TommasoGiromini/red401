...
<body>
	...
	<h2>Ciao ${param.user}</h2>

	<p class='Pick'>
		Scegli<a href="/red/pickRoom.html"> aula studio</a> più vicina a te <br>
		<br> Oppure scegli dall'<a href="/red/pickRoomList.html">elenco</a>
		<br> <br> Back <a href="/red/index.html">home</a>
	</p>
</body>
</html>